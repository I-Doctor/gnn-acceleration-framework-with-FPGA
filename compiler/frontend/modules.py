...
class SAGE(nn.Module):
    def __init__(self, in_size, hid_size, out_size, aggregation_type='mean'):
        ...
        self.layers.append(dglnn.SAGEConv(in_size, hid_size, aggregator_type=aggregation_type, bias=False, activation=F.relu))
        self.layers.append(dglnn.SAGEConv(hid_size, out_size, aggregator_type=aggregation_type, bias=False))
        self.dropout = nn.Dropout(0.5)
